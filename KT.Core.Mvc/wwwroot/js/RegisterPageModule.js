const RegisterPageModule = (function (LocalStorageModule, HttpModule, PageModule) {
    ...
    return {
        ...
        saveForm: function (form) {
            ...
            if (model) {
                const response = Http.register(model);
        ...
        validate: function () {
            let isValid = Page.validate(['first_name', 'last_name', 'user_email', 'user_pass']);
            return isValid;
        },
